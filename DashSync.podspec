...
Pod::Spec.new do |s|
  ...
  s.resource_bundles = {'DashSync' => ['DashSync/*.xcdatamodeld', 'DashSync/Models/Persistence/*.xcmappingmodel', 'DashSync/*.plist', 'DashSync/*.lproj', 'DashSync/MasternodeLists/*.dat', 'DashSync/*.json']}
