...
@implementation DSCreateIdentityFromInvitationViewController
...
- (IBAction)done:(id)sender {
    ...
    DSInvitation *invitation = [[DSInvitation alloc] initWithInvitationLink:invitationLink inWallet:self.wallet];
