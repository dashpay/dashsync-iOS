...
- (void)dealloc {
    if (_masternode_list)
        DMasternodeListDtor(_masternode_list);
}
- (void)viewDidLoad {
    [super viewDidLoad];
    self.masternode_list = [self.chain.masternodeManager currentMasternodeList];
}
...
//    NSInteger quorumType = [[sectionInfo name] integerValue];
    switch (quorumType) {
        ...
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeUnknown:
            return @"Unknown Quorums (0)";
        case dashcore_sml_llmq_type_LLMQType_Llmqtype50_60:
            return @"1 Hour Quorums (1)";
        case dashcore_sml_llmq_type_LLMQType_Llmqtype400_60:
            return @"Day Quorums (2)";
        case dashcore_sml_llmq_type_LLMQType_Llmqtype400_85:
            return @"2 Day Quorums (3)";
        case dashcore_sml_llmq_type_LLMQType_Llmqtype100_67:
            return @"1 Hour Platform Quorums (4)";
        case dashcore_sml_llmq_type_LLMQType_Llmqtype60_75:
            return @"1 Hour Rotated Quorums (v0.18) (5)";
        case dashcore_sml_llmq_type_LLMQType_Llmqtype25_67:
            return @"1 Hour Platform Quorums (v0.19) (6)";
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeTest:
            return @"Test Quorums (100)";
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeDevnet:
            return @"10 Member Devnet Quorums (101)";
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeTestV17:
            return @"Test V17 Quorums (102)";
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeTestDIP0024:
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeDevnetDIP0024:
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeTestnetPlatform:
        case dashcore_sml_llmq_type_LLMQType_LlmqtypeDevnetPlatform:
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
    return self.masternode_list ? self.masternode_list->quorums->count : 0;
//    return [[self.fetchedResultsController sections] count];
}

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return self.masternode_list ? self.masternode_list->quorums->values[section]->count : 0;
...
- (void)configureCell:(DSQuorumTableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
    if (!self.masternode_list) return;
