...
- (void)viewDidLoad {
    ...
    self.blocksResetObserver =
        [[NSNotificationCenter defaultCenter] addObserverForName:DSChainBlocksDidChangeNotification
                                                          object:nil
                                                           queue:nil
                                                      usingBlock:^(NSNotification *note) {
                                                          [self updateBlockHeight];
    ...
    self.blockchainIdentitiesObserver = [[NSNotificationCenter defaultCenter] addObserverForName:DSBlockchainIdentitiesDidUpdateNotification
                                                                                          object:nil
                                                                                           queue:nil
                                                                                      usingBlock:^(NSNotification *note) {
                                                                                          if ([note.userInfo[DSChainManagerNotificationChainKey] isEqual:[self chain]]) {
...
- (IBAction)wipeData:(id)sender {
    ...
    [wipeDataAlertController addAction:[UIAlertAction actionWithTitle:@"Chain Data"
                                                                style:UIAlertActionStyleDefault
                                                              handler:^(UIAlertAction *_Nonnull action) {
