...
@interface DSMainnetMetricSyncTests : XCTestCase
...
@implementation DSMainnetMetricSyncTests
...
- (void)testMainnetQuickHeadersSyncMetric {
...
- (void)testMainnetInitialHeadersSync2000Metric {
    if (@available(iOS 13.0, *)) {
        XCTMeasureOptions *options = [XCTMeasureOptions defaultOptions];
...
- (void)testMainnetFullSyncMetric {
    if (@available(iOS 13.0, *)) {
        XCTMeasureOptions *options = [XCTMeasureOptions defaultOptions];
        options.iterationCount = 2;
        [self measureWithMetrics:@[[[XCTCPUMetric alloc] init], [[XCTMemoryMetric alloc] init], [[XCTClockMetric alloc] init]]
