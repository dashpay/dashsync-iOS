...
//
//    BLSKey *keyPair1 = key_bls_with_seed_data(seedData1.bytes, seedData1.length, true);
//    BLSKey *keyPair2 = key_bls_with_seed_data(seedData2.bytes, seedData2.length, true);
//    uint32_t fingerprint1 = key_bls_fingerprint(keyPair1);
//    XCTAssertEqual(fingerprint1, 0x26d53247, @"Testing BLS private child public key fingerprint");
//    uint32_t fingerprint2 = key_bls_fingerprint(keyPair2);
//    XCTAssertEqual(fingerprint2, 0x289bb56e, @"Testing BLS private child public key fingerprint");
//
//    ByteArray sig1_arr = key_bls_sign_data_single_sha256(keyPair1, messageData1.bytes, messageData1.length);
//    NSData *signature1 = [NSData dataWithBytes:(const void *)sig1_arr.ptr length:sig1_arr.len];
//    processor_destroy_byte_array(sig1_arr.ptr, sig1_arr.len);
//
//    XCTAssertEqualObjects(signature1.hexString, @"93eb2e1cb5efcfb31f2c08b235e8203a67265bc6a13d9f0ab77727293b74a357ff0459ac210dc851fcb8a60cb7d393a419915cfcf83908ddbeac32039aaa3e8fea82efcb3ba4f740f20c76df5e97109b57370ae32d9b70d256a98942e5806065", @"Testing BLS signing");
//
//    ByteArray arr = key_bls_secret_key(keyPair1);
//    NSData *keyPair1SecretKey = [NSData dataWithBytes:(const void *)arr.ptr length:arr.len];
//    processor_destroy_byte_array(arr.ptr, arr.len);
//
//    XCTAssertEqualObjects(keyPair1SecretKey.hexString, @"022fb42c08c12de3a6af053880199806532e79515f94e83461612101f9412f9e", @"Testing BLS private key");
//
//    ByteArray sig2_arr = key_bls_sign_data_single_sha256(keyPair2, messageData2.bytes, messageData2.length);
//    NSData *signature2 = [NSData dataWithBytes:(const void *)sig2_arr.ptr length:sig2_arr.len];
//    processor_destroy_byte_array(sig2_arr.ptr, sig2_arr.len);
//
//    XCTAssertEqualObjects(signature2.hexString, @"975b5daa64b915be19b5ac6d47bc1c2fc832d2fb8ca3e95c4805d8216f95cf2bdbb36cc23645f52040e381550727db420b523b57d494959e0e8c0c6060c46cf173872897f14d43b2ac2aec52fc7b46c02c5699ff7a10beba24d3ced4e89c821e", @"Testing BLS signing");
//
...
//    BLSKey *keyPair1 = key_bls_with_seed_data(seedData1.bytes, seedData1.length, true);
//
//    OpaqueKey *wrapper = malloc(sizeof(OpaqueKey));
//    wrapper->key_type = DSKeyType_BLS;
//    wrapper->ptr = keyPair1;
//
//    ByteArray prv_arr = key_public_key_data(wrapper);
//    ByteArray pub_arr = key_private_key_data(wrapper);
//    NSData *privateKeyData = [NSData dataWithBytes:(const void *)prv_arr.ptr length:prv_arr.len];
//    NSData *publicKeyData = [NSData dataWithBytes:(const void *)pub_arr.ptr length:pub_arr.len];
//    processor_destroy_byte_array(prv_arr.ptr, prv_arr.len);
//    processor_destroy_byte_array(pub_arr.ptr, pub_arr.len);
//
//
//    XCTAssertEqualObjects(privateKeyData.hexString, @"02a8d2aaa6a5e2e08d4b8d406aaf0121a2fc2088ed12431e6b0663028da9ac5922c9ea91cde7dd74b7d795580acc7a61");
//    XCTAssertEqualObjects(publicKeyData.hexString, @"022fb42c08c12de3a6af053880199806532e79515f94e83461612101f9412f9e");
//
//    ByteArray sig_arr = key_bls_sign_data(keyPair1, messageData1.bytes, messageData1.length);
//    NSData *signature1 = [NSData dataWithBytes:(const void *)sig_arr.ptr length:sig_arr.len];
//    processor_destroy_byte_array(sig_arr.ptr, sig_arr.len);
...
//
//    ByteArray pk_arr = key_bls_public_key(keyPair1);
//    NSData *pkData = [NSData dataWithBytes:(const void *)pk_arr.ptr length:pk_arr.len];
//    processor_destroy_byte_array(pk_arr.ptr, pk_arr.len);
//
//    BOOL verified = key_bls_verify(pkData.bytes, true, [messageData1 SHA256_2].u8, signature1.bytes);
//    processor_destroy_bls_key(keyPair1);
//    free(wrapper);
//
