...
- (UIViewController *)ds_topViewControllerWithRootViewController:(UIViewController *)rootViewController {
    if ([rootViewController isKindOfClass:UITabBarController.class]) {
        ...
        if (!tabBarController.selectedViewController || (tabBarController.selectedViewController == tabBarController)) return tabBarController;
        ...
        if (!navigationController.visibleViewController || (navigationController.visibleViewController == navigationController)) return navigationController;
