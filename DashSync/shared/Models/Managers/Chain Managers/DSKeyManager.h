...
#define DSystemDataContract data_contracts_SystemDataContract
...
#define DLLMQType dashcore_sml_llmq_type_LLMQType
#define DLLMQTypeIndex(ptr) dashcore_sml_llmq_type_LLMQType_index(ptr)
#define DLLMQSnapshot dashcore_network_message_qrinfo_QuorumSnapshot

#define DPlatformError dash_spv_platform_error_Error
...
#define DMaybeDeriveOpaqueKeyFromExtendedPrivateKeyDataForIndexPathAsOpt(kind, data, index_path) dash_spv_crypto_keys_key_KeyKind_derive_key_from_extended_private_key_data_for_index_path_as_opt(kind, data, index_path)
#define DMaybeOpaqueKeyWithPrivateKeyData(kind, data) dash_spv_crypto_keys_key_KeyKind_key_with_private_key_data(kind, data)
#define DMaybeOpaqueKeyWithPrivateKeyDataAsOpt(kind, data) dash_spv_crypto_keys_key_KeyKind_key_with_private_key_data_as_opt(kind, data)
...
#define DMaybeOpaqueKeyWithPrivateKeyOpt(kind, key_str, data) dash_spv_crypto_keys_key_KeyKind_key_with_private_key_opt(kind, key_str, data)
#define DMaybeOpaqueKeyWithPublicKeyData(kind, data) dash_spv_crypto_keys_key_KeyKind_key_with_public_key_data(kind, data)
#define DMaybeOpaqueKeyWithPublicKeyDataAsOpt(kind, data) dash_spv_crypto_keys_key_KeyKind_key_with_public_key_data_as_opt(kind, data)
...
#define DMaybeOpaquePrivateKeyAtIndexPathOpt(kind, seed, index_path, derivation_path) dash_spv_crypto_keys_key_KeyKind_private_key_at_index_path_wrapped_as_opt(kind, seed, index_path, derivation_path)
...
#define DChainTypeMainnet() dash_spv_crypto_network_chain_type_ChainType_MainNet_ctor()
#define DChainTypeTestnet() dash_spv_crypto_network_chain_type_ChainType_TestNet_ctor()
#define DChainTypeDevnet(devnet) dash_spv_crypto_network_chain_type_ChainType_DevNet_ctor(devnet)
#define DChainTypeDevnetFromID(identifier) dash_spv_crypto_network_chain_type_devnet_type_from_identifier(identifier)
...
#define DIdentityPublicKeyDtor(ptr) dpp_identity_identity_public_key_IdentityPublicKey_destroy(ptr)
...
#define DKnownMasternodeLists std_collections_Map_keys_dashcore_prelude_CoreBlockHeight_values_dashcore_sml_masternode_list_MasternodeList
#define DKnownMasternodeListsDtor(ptr) std_collections_Map_keys_dashcore_prelude_CoreBlockHeight_values_dashcore_sml_masternode_list_MasternodeList_destroy(ptr)
...
#define DContactRequests Vec_dash_spv_platform_models_contact_request_ContactRequest
#define DMaybeContactRequests Result_ok_Vec_dash_spv_platform_models_contact_request_ContactRequest_err_dash_spv_platform_error_Error
#define DMaybeContactRequestsDtor(ptr) Result_ok_Vec_dash_spv_platform_models_contact_request_ContactRequest_err_dash_spv_platform_error_Error_destroy(ptr)
...
#define DContactRequestKinds Vec_dash_spv_platform_models_contact_request_ContactRequestKind
#define DMaybeContactRequestKinds Result_ok_Vec_dash_spv_platform_models_contact_request_ContactRequestKind_err_dash_spv_platform_error_Error
#define DMaybeContactRequestKindsDtor(ptr) Result_ok_Vec_dash_spv_platform_models_contact_request_ContactRequestKind_err_dash_spv_platform_error_Error_destroy(ptr)

//#define DFetchOutgoingContactRequests(identity, contract, since, start_after, storage_context, has_contact_request_with_id) dash_spv_platform_document_contact_request_ContactRequestManager_fetch_outgoing_contact_requests_in_context(identity.chain.sharedRuntimeObj, identity.chain.sharedContactsObj, identity.model, contract, since, start_after, storage_context, ((__bridge void *)(identity)), has_contact_request_with_id)
//#define DFetchIncomingContactRequests(identity, contract, since, start_after, storage_context, has_contact_request_with_id) dash_spv_platform_document_contact_request_ContactRequestManager_fetch_incoming_contact_requests_in_context(identity.chain.sharedRuntimeObj, identity.chain.sharedContactsObj, identity.model, contract, since, start_after, storage_context, ((__bridge void *)(identity)), has_contact_request_with_id)
...
#define DTransientUser dash_spv_platform_models_transient_dashpay_user_TransientDashPayUser
#define DTransientUserDtor(ptr) dash_spv_platform_models_transient_dashpay_user_TransientDashPayUser_destroy(ptr)
#define DMaybeTransientUser Result_ok_dash_spv_platform_models_transient_dashpay_user_TransientDashPayUser_err_dash_spv_platform_error_Error
#define DMaybeTransientUserDtor(ptr) Result_ok_dash_spv_platform_models_transient_dashpay_user_TransientDashPayUser_err_dash_spv_platform_error_Error_destroy(ptr)
...
#define DIdentityPubKeyData(key) dash_spv_platform_identity_manager_identity_public_key_data(key)
...
#define DIdentityKeyStatus dash_spv_platform_identity_key_status_IdentityKeyStatus
#define DIdentityKeyStatusDtor(ptr) dash_spv_platform_identity_key_status_IdentityKeyStatus_destroy(ptr)
#define DIdentityRegistrationStatus dash_spv_platform_identity_registration_status_IdentityRegistrationStatus
#define DIdentityRegistrationStatusDtor(ptr) dash_spv_platform_identity_registration_status_IdentityRegistrationStatus_destroy(ptr)
#define DIdentityRegistrationStatusIndex(ptr) dash_spv_platform_identity_model_IdentityModel_registration_status_index(ptr)
#define DIdentityRegistrationStatusFromIndex(index) dash_spv_platform_identity_registration_status_IdentityRegistrationStatus_from_index(index)
#define DIdentityRegistrationStatusUnknown() dash_spv_platform_identity_registration_status_IdentityRegistrationStatus_Unknown_ctor()
#define DIdentityRegistrationStatusRegistered() dash_spv_platform_identity_registration_status_IdentityRegistrationStatus_Registered_ctor()

#define DKeyInfo dash_spv_platform_identity_key_info_KeyInfo
#define DKeyInfoCtor(key, status, security_level, purpose) dash_spv_platform_identity_key_info_KeyInfo_ctor(key, status, security_level, purpose)
#define DKeyInfoDtor(ptr) dash_spv_platform_identity_key_info_KeyInfo_destroy(ptr)
#define DKeyInfoDictionaries std_collections_Map_keys_u32_values_dash_spv_platform_identity_key_info_KeyInfo
#define DKeyInfoDictionariesDtor(ptr) std_collections_Map_keys_u32_values_dash_spv_platform_identity_key_info_KeyInfo_destroy(ptr)
...
#define DIdentityModelSetBalance(model, balance) dash_spv_platform_identity_model_IdentityModel_set_credit_balance(model, balance)

#define DSaveUsernameContext dash_spv_platform_identity_storage_username_SaveUsernameContext

#define DIdentityModelSetSyncBlockHash(model, block_hash) dash_spv_platform_identity_model_IdentityModel_set_sync_block_hash(model, block_hash)
#define DIdentityModelSetLastCheckedProfileTimestamp(model, timestamp) dash_spv_platform_identity_model_IdentityModel_set_last_checked_profile_timestamp(model, timestamp)
#define DIdentityModelSetLastCheckedUsernamesTimestamp(model, timestamp) dash_spv_platform_identity_model_IdentityModel_set_last_checked_usernames_timestamp(model, timestamp)
#define DIdentityModelSetLastCheckedIncomingContactsTimestamp(model, timestamp) dash_spv_platform_identity_model_IdentityModel_set_last_checked_incoming_contacts_timestamp(model, timestamp)
#define DIdentityModelSetLastCheckedOutgoingContactsTimestamp(model, timestamp) dash_spv_platform_identity_model_IdentityModel_set_last_checked_outgoing_contacts_timestamp(model, timestamp)

#define DIdentityModelAddKeyInfo(model, index, key_info) dash_spv_platform_identity_model_IdentityModel_add_key_info(model, index, key_info)
#define DIdentityModelSyncBlockHash(model) dash_spv_platform_identity_model_IdentityModel_sync_block_hash(model)
#define DIdentityModelLastCheckedProfileTimestamp(model) dash_spv_platform_identity_model_IdentityModel_last_checked_profile_timestamp(model)
#define DIdentityModelLastCheckedUsernamesTimestamp(model) dash_spv_platform_identity_model_IdentityModel_last_checked_usernames_timestamp(model)
#define DIdentityModelLastCheckedIncomingContactsTimestamp(model) dash_spv_platform_identity_model_IdentityModel_last_checked_incoming_contacts_timestamp(model)
#define DIdentityModelLastCheckedOutgoingContactsTimestamp(model) dash_spv_platform_identity_model_IdentityModel_last_checked_outgoing_contacts_timestamp(model)
#define DIdentityModelSetKeysCreated(model, new_value) dash_spv_platform_identity_model_IdentityModel_set_keys_created(model, new_value)
#define DIdentityModelKeysCreated(model) dash_spv_platform_identity_model_IdentityModel_keys_created(model)

#define DIdentityModelIndex(model) dash_spv_platform_identity_model_IdentityModel_index(model)
...
#define DIdentityKeyStatusFromIndex(index) dash_spv_platform_identity_key_status_IdentityKeyStatus_from_index(index)
#define DIdentityKeyStatusToIndex(status) dash_spv_platform_identity_key_status_IdentityKeyStatus_to_index(status)

#define DIdentityKeyStatusRegistered() dash_spv_platform_identity_key_status_IdentityKeyStatus_Registered_ctor()

#define DUsernameStatusInfo dash_spv_platform_identity_username_status_info_UsernameStatusInfo
#define DUsernameStatuses std_collections_Map_keys_String_values_dash_spv_platform_identity_username_status_info_UsernameStatusInfo
#define DUsernameStatusesDtor(ptr) std_collections_Map_keys_String_values_dash_spv_platform_identity_username_status_info_UsernameStatusInfo_destroy(ptr)

#define DBLSPublicKey dashcore_bls_sig_utils_BLSPublicKey
#define DBLSPublicKeyCtor(key) dashcore_bls_sig_utils_BLSPublicKey_ctor(key)
...
#define DQuorumEntry dashcore_blockdata_transaction_special_transaction_quorum_commitment_QuorumEntry
#define DQuorumEntryCtor(qf_commit_version, llmq_type, quorum_hash, quorum_index, signers, valid_members, quorum_public_key, quorum_vvec_hash, threshold_sig, all_commitment_aggregated_signature) dashcore_blockdata_transaction_special_transaction_quorum_commitment_QuorumEntry_ctor(qf_commit_version, llmq_type, quorum_hash, quorum_index, signers, valid_members, quorum_public_key, quorum_vvec_hash, threshold_sig, all_commitment_aggregated_signature)

#define DQuorumHash dashcore_hash_types_QuorumHash
#define DPubkeyHash dashcore_hash_types_PubkeyHash
#define DProTxHash dashcore_hash_types_ProTxHash
#define DBlockHash dashcore_hash_types_BlockHash
#define DCycleHash dashcore_hash_types_CycleHash
#define DInputsHash dashcore_hash_types_InputsHash
#define DMerkleRootMasternodeList dashcore_hash_types_MerkleRootMasternodeList
#define DMerkleRootQuorums dashcore_hash_types_MerkleRootQuorums
#define DQuorumVVecHash dashcore_hash_types_QuorumVVecHash

#define DQuorumHashCtor(value) dashcore_hash_types_QuorumHash_ctor(value)
#define DPubkeyHashCtor(value) dashcore_hash_types_PubkeyHash_ctor(value)
#define DProTxHashCtor(value) dashcore_hash_types_ProTxHash_ctor(value)
#define DInputsHashCtor(value) dashcore_hash_types_InputsHash_ctor(value)
#define DMerkleRootMasternodeListCtor(value) dashcore_hash_types_MerkleRootMasternodeList_ctor(value)
#define DMerkleRootQuorumsCtor(value) dashcore_hash_types_MerkleRootQuorums_ctor(value)
#define DQuorumVVecHashCtor(value) dashcore_hash_types_QuorumVVecHash_ctor(value)

#define DProviderMasternodeType dashcore_blockdata_transaction_special_transaction_provider_registration_ProviderMasternodeType
#define DProviderMasternodeTypeRegular dashcore_blockdata_transaction_special_transaction_provider_registration_ProviderMasternodeType_Regular
#define DProviderMasternodeTypeHighPerformance dashcore_blockdata_transaction_special_transaction_provider_registration_ProviderMasternodeType_HighPerformance
#define DProviderMasternodeTypeRegularCtor() dashcore_blockdata_transaction_special_transaction_provider_registration_ProviderMasternodeType_Regular_ctor()
#define DProviderMasternodeTypeHighPerformanceCtor() dashcore_blockdata_transaction_special_transaction_provider_registration_ProviderMasternodeType_HighPerformance_ctor()
...
#define DAssetLockPayloadCtor(payload_version, credit_outputs) dashcore_blockdata_transaction_special_transaction_asset_lock_AssetLockPayload_ctor(payload_version, credit_outputs)

#define DAssetUnlockPayloadCtor(base, request_info, quorum_sig) dashcore_blockdata_transaction_special_transaction_asset_unlock_qualified_asset_unlock_AssetUnlockPayload_ctor(base, request_info, quorum_sig)
#define DAssetUnlockRequestInfo dashcore_blockdata_transaction_special_transaction_asset_unlock_request_info_AssetUnlockRequestInfo
#define DAssetUnlockRequestInfoCtor(requested_height, quorum_hash) dashcore_blockdata_transaction_special_transaction_asset_unlock_request_info_AssetUnlockRequestInfo_ctor(requested_height, quorum_hash)
#define DAssetUnlockBasePayload dashcore_blockdata_transaction_special_transaction_asset_unlock_unqualified_asset_unlock_AssetUnlockBasePayload
#define DAssetUnlockBasePayloadCtor(version, index, fee) dashcore_blockdata_transaction_special_transaction_asset_unlock_unqualified_asset_unlock_AssetUnlockBasePayload_ctor(version, index, fee)


#define DProviderRegistrationPayloadCtor(version, masternode_type, masternode_mode, collateral_outpoint, service_address, owner_key_hash, operator_public_key, voting_key_hash, operator_reward, script_payout, inputs_hash, signature, platform_node_id, platform_p2p_port, platform_http_port) dashcore_blockdata_transaction_special_transaction_provider_registration_ProviderRegistrationPayload_ctor(version, masternode_type, masternode_mode, collateral_outpoint, service_address, owner_key_hash, operator_public_key, voting_key_hash, operator_reward, script_payout, inputs_hash, signature, platform_node_id, platform_p2p_port, platform_http_port)

#define DProviderUpdateServicePayloadCtor(version, pro_tx_hash, ip_address, port, script_payout, inputs_hash, payload_sig) dashcore_blockdata_transaction_special_transaction_provider_update_service_ProviderUpdateServicePayload_ctor(version, pro_tx_hash, ip_address, port, script_payout, inputs_hash, payload_sig)

#define DProviderUpdateRegistrarPayloadCtor(version, pro_tx_hash, provider_mode, operator_public_key, voting_key_hash, script_payout, inputs_hash, payload_sig) dashcore_blockdata_transaction_special_transaction_provider_update_registrar_ProviderUpdateRegistrarPayload_ctor(version, pro_tx_hash, provider_mode, operator_public_key, voting_key_hash, script_payout, inputs_hash, payload_sig)

#define DProviderUpdateRevocationPayloadCtor(version, pro_tx_hash, reason, inputs_hash, payload_sig) dashcore_blockdata_transaction_special_transaction_provider_update_revocation_ProviderUpdateRevocationPayload_ctor(version, pro_tx_hash, reason, inputs_hash, payload_sig)

#define DCoinbasePayloadCtor(version, height, merkle_root_masternode_list, merkle_root_quorums, best_cl_height, best_cl_signature, asset_locked_amount) dashcore_blockdata_transaction_special_transaction_coinbase_CoinbasePayload_ctor(version, height, merkle_root_masternode_list, merkle_root_quorums, best_cl_height, best_cl_signature, asset_locked_amount)

#define DQuorumCommitmentPayloadCtor(version, height, quorum_entry) dashcore_blockdata_transaction_special_transaction_quorum_commitment_QuorumCommitmentPayload_ctor(version, height, quorum_entry)


#define DProviderRegistrationPayload dashcore_blockdata_transaction_special_transaction_provider_registration_ProviderRegistrationPayload
#define DProviderUpdateServicePayload dashcore_blockdata_transaction_special_transaction_provider_update_service_ProviderUpdateServicePayload
#define DProviderUpdateRegistrarPayload dashcore_blockdata_transaction_special_transaction_provider_update_registrar_ProviderUpdateRegistrarPayload
#define DProviderUpdateRevocationPayload dashcore_blockdata_transaction_special_transaction_provider_update_revocation_ProviderUpdateRevocationPayload
#define DCoinbasePayload dashcore_blockdata_transaction_special_transaction_coinbase_CoinbasePayload
#define DQuorumCommitmentPayload dashcore_blockdata_transaction_special_transaction_quorum_commitment_QuorumCommitmentPayload
#define DAssetLockPayload dashcore_blockdata_transaction_special_transaction_asset_lock_AssetLockPayload
#define DAssetUnlockPayload dashcore_blockdata_transaction_special_transaction_asset_unlock_qualified_asset_unlock_AssetUnlockPayload


#define DTransactionPayloadProviderRegistrationCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_ProviderRegistrationPayloadType_ctor(payload)
#define DTransactionPayloadProviderUpdateServiceCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_ProviderUpdateServicePayloadType_ctor(payload)
#define DTransactionPayloadProviderUpdateRegistrarCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_ProviderUpdateRegistrarPayloadType_ctor(payload)
#define DTransactionPayloadProviderUpdateRevocationCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_ProviderUpdateRevocationPayloadType_ctor(payload)
#define DTransactionPayloadCoinbaseCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_CoinbasePayloadType_ctor(payload)
#define DTransactionPayloadQuorumCommitmentCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_QuorumCommitmentPayloadType_ctor(payload)
#define DTransactionPayloadAssetLockCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_AssetLockPayloadType_ctor(payload)
#define DTransactionPayloadAssetUnlockCtor(payload) dashcore_blockdata_transaction_special_transaction_TransactionPayload_AssetUnlockPayloadType_ctor(payload)
...
#define DOutPointFromUTXO(utxo) DOutPointCtorU(uint256_reverse(utxo.hash), (uint32_t) utxo.n)
...
#define DTransactionPayload dashcore_blockdata_transaction_special_transaction_TransactionPayload
