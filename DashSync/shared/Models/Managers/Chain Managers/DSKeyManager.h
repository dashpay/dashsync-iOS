...
#define DMNSyncState dash_spv_masternode_processor_models_sync_state_SyncState
#define DMNSyncStateDtor(ptr) dash_spv_masternode_processor_models_sync_state_SyncState_destroy(ptr)
#define DMNSyncStateQueueChanged dash_spv_masternode_processor_models_sync_state_SyncState_QueueChanged
#define DMNSyncStateStoreChanged dash_spv_masternode_processor_models_sync_state_SyncState_StoreChanged
...
//#define DArcMasternodeListForBlockHash(processor, block_hash) dash_spv_masternode_processor_processing_processor_MasternodeProcessor_masternode_list_for_block_hash(processor, block_hash)
...
//#define DArcMasternodeListByBlockHash(cache, block_hash) dash_spv_masternode_processor_processing_processor_cache_MasternodeProcessorCache_masternode_list_by_block_hash(cache, block_hash)
