...
typedef NS_ENUM(NSUInteger, DSSyncType)
{
    ...
    DSSyncType_Identities = 1 << 7,
    DSSyncType_DPNS = 1 << 8,
    DSSyncType_Dashpay = 1 << 9,
    DSSyncType_MultiAccountAutoDiscovery = 1 << 10,
    DSSyncType_Default = DSSyncType_SPV | DSSyncType_Mempools | DSSyncType_VerifiedMasternodeList | DSSyncType_Sporks | DSSyncType_Identities | DSSyncType_DPNS | DSSyncType_Dashpay | DSSyncType_MultiAccountAutoDiscovery,
