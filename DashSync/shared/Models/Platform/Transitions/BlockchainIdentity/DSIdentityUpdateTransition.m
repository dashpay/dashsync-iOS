...
@implementation DSIdentityUpdateTransition
...
//    self.identityResetTransactionVersion = [message UInt16AtOffset:off];
//    off += 2;
//
...
//    self.identityResetTransactionVersion = version;
...
//}
//
//-(instancetype)initWithIdentityResetTransactionVersion:(uint16_t)version registrationTransactionHash:(UInt256)registrationTransactionHash previousIdentityTransactionHash:(UInt256)previousIdentityTransactionHash replacementPublicKeyHash:(UInt160)replacementPublicKeyHash creditFee:(uint64_t)creditFee onChain:(DSChain *)chain {
//    NSParameterAssert(chain);
//
...
////    [data appendUInt16:self.identityResetTransactionVersion];
...
//    DSECDSAKey * identityPublicKey = [DSECDSAKey keyRecoveredFromCompactSig:self.oldPublicKeyPayloadSignature andMessageDigest:[self payloadHash]];
//    return uint160_eq([dentityPublicKey hash160], oldPublicKeyHash);
//}
//
