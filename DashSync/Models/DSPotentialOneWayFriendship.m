...
- (DSIncomingFundsDerivationPath *)createDerivationPath {
    ...
    self.fundsDerivationPathForContact = [DSIncomingFundsDerivationPath
        contactBasedDerivationPathWithDestinationBlockchainIdentityUniqueId:self.destinationContact.associatedBlockchainIdentityUniqueId
    ...
    [self.sourceBlockchainIdentity encryptData:self.extendedPublicKey
