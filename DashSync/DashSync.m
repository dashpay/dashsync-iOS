...
- (void)wipeBlockchainDataForChain:(DSChain *)chain {
    ...
    [context performBlockAndWait:^{
        ...
        [DSContactEntity deleteContactsOnChain:chainEntity]; // this must move after wipeBlockchainInfo where blockchain identities are removed
...
- (void)performFetchWithCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler {
    ...
    self.syncFinishedNotificationObserver =
        [notificationCenter addObserverForName:DSTransactionManagerSyncFinishedNotification
                                        object:nil
                                         queue:nil
                                    usingBlock:^(NSNotification *note) {
